						  ...
						  <div class="col-md-6">
							...
							<?php echo __('please check below and compare with your server current status on the right. You can click on the icon next to each technology for details.');?>
							  <div class="table-responsive">
								...
								<tr>
								  <td><?php echo __('PHP 5.2.8 or greater and less than 7');?></td>
								  <td><span class="label label-success"><?php echo __('Require');?></span></td>
								</tr>
								<tr>
							...
							<div class="panel-body">							  
							  <div class="table-responsive">
								...
								<tr>
								  ...
								  <td><?php $phpversion=phpversion(); if($phpversion>="5.2.8"){?><span class="label label-success"><?php echo $phpversion;?></span><?php } elseif($phpversion>="7"){?><span class="label label-danger"><?php echo $phpversion;?></span><?php } else{?><span class="label label-warning"><?php echo $phpversion;?></span><?php }?></td>
								</tr>
								<tr>
								...
								<tr>
								  <td><?php echo __('GD Extension');?></td>
								  <td><?php if (extension_loaded('gd') && function_exists('gd_info')) {?><span class="label label-success"><?php echo __('GD Available');?></span><?php } else{?><span class="label label-warning"><?php echo __('GD Unavailable');?></span><?php }?></td>
								</tr>
							      </tbody>							  
							  </table>
							</div>
