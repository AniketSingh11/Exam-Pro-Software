<style>.dg-icon {width: 100%;height: 240px;background: url('<?php echo $this->webroot;?>img/langs/guidelines.<?php echo$configLanguage;?>.png') -5px 0 no-repeat;}</style>
<div class="col-md-9 col-sm-offset-2">
	...
	<div class="panel-body">	    
		...
		<div class="wrap"> 
		    <div class="panel">
			<div class="row">
			    <div class="col-sm-5 col-xs-12 dg-content"><?php echo __('Please close all of your chat windows, screen-saver, and anti-virus programs before starting your test');?></div>
		    ...
		    <div class="panel">
			<div class="col-sm-5 col-xs-12 dg-content">
